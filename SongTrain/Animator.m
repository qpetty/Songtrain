...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext
{
    ...
    if (self.firstTime) {
        ...
        newView.frame = CGRectMake(fromViewController.view.bounds.origin.x - 30, fromViewController.view.bounds.origin.y - 20, fromViewController.view.bounds.size.width * 1.5 + 60, fromViewController.view.bounds.size.height + 40);
